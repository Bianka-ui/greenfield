...
static const struct encoder_description encoder_descriptions[] = {
        ...
        },
        {
                ...
                .opaque_pipeline_definition = "appsrc name=src format=3 stream-type=0 ! "
                                       ...
                                       "nvh264enc gop-size=-1 zerolatency=true preset=4 rc-mode=5 bitrate=7200 vbv-buffer-size=120 spatial-aq=true aq-strength=10 ! "
                                       "video/x-h264,profile=high,stream-format=byte-stream,alignment=au ! "
                                       "appsink name=sink ",
                .alpha_pipeline_definition = "appsrc name=src format=3 stream-type=0 ! "
                                              "glupload ! "
                                              ...
                                              "queue silent=true ! "
                                              // TODO use cudascale/cudaconvert once gstreamer 1.22 is released
                                              "nvh264enc gop-size=-1 zerolatency=true preset=4 rc-mode=5 bitrate=900 vbv-buffer-size=15 spatial-aq=true aq-strength=5 ! "
                                       "video/x-h264,profile=high,stream-format=byte-stream,alignment=au ! "
                                       "appsink name=sink ",
                .split_alpha = true,
                .width_multiple = 128,
