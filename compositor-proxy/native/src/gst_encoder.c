...
static const struct encoder_description encoder_descriptions[] = {
        {
                ...
                .pipeline_definition = "appsrc name=src format=3 stream-type=0 ! "
                                       ...
                                       // The ueue is silent
                                       "queue silent=true ! "
                                       "x264enc me=2 analyse=51 dct8x8=true cabac=true bframes=0 b-adapt=false rc-lookahead=0 sliced-threads=true qp-max=28 byte-stream=true tune=zerolatency psy-tune=2 pass=0 bitrate=9600 vbv-buf-capacity=125 ! "
        ...
        },
        {
                ...
                .pipeline_definition = "appsrc name=src format=3 stream-type=0 ! "
                                       ...
                                       "nvh264enc gop-size=-1 qp-max=24 qp-min=6 zerolatency=true preset=5 rc-mode=5 bitrate=6000 vbv-buffer-size=750 ! "
                                       "video/x-h264,profile=high,stream-format=byte-stream,alignment=au ! "
                                       "appsink name=sink ",
                .split_alpha = true,
                .width_multiple = 128,
